...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            {
                current_Count -= (Time.fixedDeltaTime / CountDuration) * starting_Count;

                if (current_Count <= 3)
                {
                    //Debug.Log("Fading Counter ... " + current_Count.ToString("f2"));
                    alpha = Mathf.Clamp(alpha - (Time.fixedDeltaTime / fadeDuration) * 255, 0, 255);
                }
                ...
                m_floatingText_Transform.position += new Vector3(0, starting_Count * Time.fixedDeltaTime, 0);
